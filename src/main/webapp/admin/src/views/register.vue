<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于HTML5的网上跳蚤市场注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='maijia'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`maijia` == this.tableName && this.ruleForm.lianxifangshi&&(!this.$validate.isMobile(this.ruleForm.lianxifangshi))){
